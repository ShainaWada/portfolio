...
export default function Home() {
  return (
    ...
    <div className="w-full flex flex-col justify-center gap-12 sm:flex-row sm:items-center sm:justify-around">
      <div className="flex flex-col items-center sm:items-start">
        <p className="animate-fade-right animate-delay-[500ms] animate-ease-out md:text-xl">Hello there!</p>
